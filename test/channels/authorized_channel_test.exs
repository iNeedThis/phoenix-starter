defmodule PhoenixStarter.AuthorizedChannelTest do
  use PhoenixStarter.ChannelCase

  alias PhoenixStarter.AuthorizedChannel
  ...
  setup do
    ...
    {:ok, _, socket} =
      socket()
      |> subscribe_and_join(
        AuthorizedChannel, "authorized:lobby", %{"guardian_token" => "#{jwt}"}
      )
