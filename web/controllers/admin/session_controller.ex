defmodule PhoenixStarter.Admin.SessionController do
  @moduledoc """
  ...
  """
  use PhoenixStarter.Web, :admin_controller

  alias PhoenixStarter.{UserFromAuth, User}
  ...
  # We've aliased Guardian.Plug.EnsureAuthenticated in our PhoenixStarter.Web.admin_controller macro
